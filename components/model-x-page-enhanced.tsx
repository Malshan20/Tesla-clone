...
export function ModelXPageEnhanced() {
  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://media.ed.edmunds-media.com/tesla/model-x/2024/oem/2024_tesla_model-x_4dr-suv_plaid_fq_oem_4_1280x855.jpg?height=1080&width=1920')",
      ...
      >
        ...
        >
          <h1 className="model text-7xl font-medium mb-2">Model X</h1>
          <p className="apr text-4xl font-medium mb-2">From $65,990</p>
          <p className="lease text-xl font-medium text-white/90">
          After Federal Tax Credit $7,500
          and Est. Gas Savings $6,500<sup>†</sup>
          </p>
        </div>
